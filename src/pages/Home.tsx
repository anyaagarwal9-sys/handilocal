...
const Home = () => {
  ...
  return <div className="min-h-screen overflow-hidden">
      ...
      <section className="relative py-16 px-4 overflow-hidden md:py-[50px]">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <motion.div className="text-center" initial="initial" animate="animate" variants={staggerContainer}>
            ...
            <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-foreground drop-shadow-md leading-tight">
              Discover the Hands{" "}
              <span className="text-primary relative">
                Behind
                <motion.div className="absolute -bottom-2 left-0 right-0 h-3 bg-secondary/30 -z-10 rounded" initial={{
                scaleX: 0
              }} animate={{
                scaleX: 1
              }} transition={{
            ...
            <motion.p variants={fadeInUp} className="text-lg md:text-xl mb-8 text-foreground/90 max-w-3xl mx-auto leading-relaxed drop-shadow-sm">
            ...
            <motion.p variants={fadeInUp} className="text-2xl md:text-3xl font-bold mb-10 text-foreground drop-shadow-md">
          ...
          loop: true
            ...
            <CarouselContent className="-ml-2 md:-ml-4">
              {galleryImages.map((image, index) => <CarouselItem key={index} className="pl-2 md:pl-4 basis-1/2 md:basis-1/3 lg:basis-1/4">
                  <motion.div className="aspect-square rounded-2xl overflow-hidden border border-border/50 shadow-md hover:shadow-lg transition-shadow" whileHover={{
                scale: 1.02
              }}>
                    <img src={image.src} alt={image.alt} className="w-full h-full object-cover sepia-[0.15] saturate-[1.1] brightness-[1.05]" loading="lazy" />
                  </motion.div>
                </CarouselItem>)}
            </CarouselContent>
      ...
      <section className="py-10 px-4 bg-gradient-to-r from-primary to-primary/90 relative overflow-hidden">
        <motion.div className="absolute inset-0 opacity-10 border-dotted" style={{
      ...
      <section className="py-12 px-4 bg-card relative md:py-[20px]">
        <div className="container mx-auto max-w-6xl">
          ...
          <motion.div className="grid md:grid-cols-3 gap-6 mb-16" variants={staggerContainer} initial="initial" whileInView="animate" viewport={{
          once: true
        }}>
            {[{
            icon: Wifi,
            ...
            highlight: "GST"
          }].map((item, index) => <motion.div key={item.title} className="glass-card rounded-2xl p-8 hover-lift cursor-default group py-[20px]" variants={scaleIn} whileHover={{
            scale: 1.02
          }}>
          ...
          {/* Noida Stats */}
          <motion.div className="bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 rounded-3xl p-8 md:p-12 border border-primary/20 relative overflow-hidden" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          once: true
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 relative z-10">
              ...
              <div className="flex gap-6">
                <motion.div className="text-center bg-background rounded-2xl p-6 shadow-lg min-w-[140px]" whileHover={{
                scale: 1.05
              }}>
      ...
      <section className="py-12 px-4 bg-background md:py-[30px]">
        <div className="container mx-auto max-w-6xl">
          ...
          <motion.div className="flex flex-wrap justify-center gap-4" variants={staggerContainer} initial="initial" whileInView="animate" viewport={{
          once: true
        }}>
            {["Rajasthani Puppets", "Handwoven Textiles", "Handcrafted Jewellery", "Artisan Bags", "Home Decor", "Art & Paintings", "Hand-crafted Oud"].map((product, index) => <motion.div key={product} className="px-6 py-3 bg-card border border-border/50 rounded-full text-foreground font-medium hover:border-primary hover:bg-primary/5 transition-all cursor-default" variants={scaleIn} whileHover={{
            scale: 1.05,
            y: -2
          }}>
                {product}
      ...
      <section className="py-12 px-4 bg-card relative md:py-[30px]">
        <div className="container mx-auto max-w-6xl">
          ...
          }].map((item, index) => <motion.div key={item.title} className="text-center p-8 rounded-3xl hover:bg-background transition-colors duration-300 group" variants={fadeInUp}>
                <motion.div className="w-20 h-20 rounded-3xl bg-primary/10 flex items-center justify-center mx-auto mb-6 group-hover:bg-primary/20 transition-colors" whileHover={{
              rotate: [0, -10, 10, 0],
              transition: {
                duration: 0.5
              }
      ...
      <section className="py-10 px-4 bg-background md:py-[40px]">
        <div className="container mx-auto max-w-4xl">
          <motion.div className="grid md:grid-cols-3 gap-8 text-center" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
          ...
          }].map(item => <div key={item.title} className="flex flex-col items-center">
